        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-xl font-bold text-white tracking-tight">Sony Aircon</h3>
                <p className="text-xs text-slate-500 uppercase tracking-widest font-semibold">Climate Experts</p>
              </div>
            </div>
        ...
        <div className="border-t border-slate-800 mt-16 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-slate-500 text-center md:text-left">
              © {new Date().getFullYear()} Sony Aircon. All rights reserved.
            </p>
