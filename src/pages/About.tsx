      ...
      <section className="py-16 md:py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-12 relative z-10">
          <div className="max-w-4xl mx-auto mb-16 text-center">
            ...
            >
              Founded in 2009 by Rajesh Sharma, Sony Aircon began as a small family business with a mission to provide reliable cooling solutions. Today, we have redefined the flow of cool air conditioning, transitioning from product sales to a complete solution provider.
            </motion.p>
          </div>
